...
import { apiServicesStatus, apiServicesRestart } from '../apiSsh';
  ...
  return (
    <div style={st.container}>
      <div style={st.panel}>
        <div style={st.headerRow}>
          <div>
            ...
            <div style={st.panelSub}>
              Managed by systemd on the Jetson — start automatically on boot. Use this panel to verify health or restart after a config change.
            </div>
          </div>
        ...
        <div style={st.hint}>
          Restart needs passwordless sudo for the <code>ada</code> user on the Jetson. If you see a sudo error, run:
